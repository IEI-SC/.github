# IEI Student Chapter RCCIIT - Official Website

<div align="center">

# 🏛️ IEI Student Chapter RCCIIT
...
- **🎓 IEI India:** [https://www.ieindia.org](https://www.ieindia.org)
- **🏫 RCCIIT:** [https://rcciit.org](https://rcciit.org)

## 🚀 Features

### 💫 Modern Design
- **Tech-Themed Interface** with animated circuit board backgrounds
- **Fully Responsive** design for all devices
- **Dark Theme** with professional cyan accent colors
...
- **📖 About Us** - Mission, vision, and membership benefits
- **📅 Events** - Upcoming workshops, seminars, and competitions
- **👥 Our Team** - Faculty advisors and student leadership
- **📞 Contact** - Location details and contact information

## 🎯 Our Mission

To foster technical excellence, innovation, and professional growth among engineering students through:

- 🛠 **Technical Workshops** & Hands-on Sessions
- 💡 **Project Funding** & Mentorship
- 🤝 **Industry Expert** Interactions
- 🏆 **Technical Competitions** & Events
...
We welcome contributions from students and developers! Feel free to:
...
## 🎓 Created with ❤️ by IEI Student Chapter RCCIIT

**Empowering Engineering Students Through Innovation and Excellence**
